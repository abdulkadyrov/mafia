...
import { APP_AUTH } from "../core/auth/authConfig";
...
export function AuthPage({
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#16324f_0%,#07111f_40%,#020617_100%)] px-4 py-5 text-white">
      <div className="mx-auto grid min-h-[calc(100dvh-2.5rem)] max-w-5xl gap-5 lg:grid-cols-[0.95fr_1.05fr]">
        <motion.section
        ...
        <Card className="self-center">
          ...
          <p className="mt-4 text-xs font-semibold text-white/45">
            Текущие данные входа: {APP_AUTH.login} / {APP_AUTH.password}
          </p>
        </Card>
      </div>
    </main>
